...
select * from database_productionsale.warehouses;
insert into database_productionsale.warehouses (title, address, city, createdat, updatedat) values('Central', 'avenida test', 'Santa Cruz',now(), now());
...
insert into database_productionsale.modules (title, class, createdat, updatedat) values ('Contabilidad', 'fa fa-desktop', now(), now());
...
insert into database_productionsale.pages (title, path, createdat, updatedat, idmodule) values ('Centro Costo', 'costcenter', now(), now(),3);
insert into database_productionsale.pages (title, path, createdat, updatedat, idmodule) values ('Grupo de cuentas', 'group', now(), now(),3);
insert into database_productionsale.pages (title, path, createdat, updatedat, idmodule) values ('Cuentas contables', 'account', now(), now(),3);
...
insert into database_productionsale.pages (title, path, createdat, updatedat, idmodule) values ('Cliente', 'customer', now(), now(),4);
...
select * from database_productionsale.userwarehouses;
insert into database_productionsale.userwarehouses (createdat, updatedat, iduser, idwarehouse) values(now(), now(), 1, 1);
...
insert into database_productionsale.permits (createdat, updatedat, idpage, idrole) values(now(), now(), 18, 1);
...
insert into database_productionsale.permits (createdat, updatedat, idpage, idrole) values(now(), now(), 23, 1);

select * from database_productionsale.settings;
insert into database_productionsale.settings (title, numberid, note, createdat, updatedat) values('empresa de prueba',123456789,'NO SE ACEPTAN CAMBIOS NI DEVOLUCIONES', now(), now());
