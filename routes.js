...
module.exports = function (app) {
	...
	app.use('/customer', require('./server/routes/customers'));
	app.use('/groups', require('./server/routes/groups'));
	app.use('/costcenters', require('./server/routes/costcenters'));
	app.use('/accounts', require('./server/routes/accounts'));
	app.use('/accountingtransactions', require('./server/routes/accountingtransactions'));
};