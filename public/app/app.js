var app = angular.module('blesssystemApp', ['ngRoute', 'uitls.paginate', 'ngStorage', 'isteven-multi-select']);
...
app.config(function ($routeProvider, $httpProvider) {
    $routeProvider
        ...
        .when('/customer', {
            ...
            templateUrl: 'app/partials/sales/customer.html'
        })
        .when('/costcenter', {
            controller: 'CostcenterController',
            templateUrl: 'app/partials/accounting/costcenter.html'
        })
        .when('/group', {
            controller: 'GroupController',
            templateUrl: 'app/partials/accounting/group.html'
        })
        .when('/account', {
            controller: 'AccountController',
            templateUrl: 'app/partials/accounting/account.html'
        })
        .when('/accounting', {
            controller: 'AccountingController',
            templateUrl: 'app/partials/accounting/accounting.html'
        })
        .when('/user', {
        ...
        .when('/office', {
            ...
            templateUrl: 'app/partials/security/office.html'
        })
        .when('/orderbook', {
            controller: 'OrderbookController',
            templateUrl: 'app/partials/accounting/orderbook.html'
        })
        .when('/sale', {
